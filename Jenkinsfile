        ...
        */
        stage('Deploy to Web Server') {
            steps {
                ...
                sshagent(['ClaveSSH']) {
                    sh '''
                        ssh -o StrictHostKeyChecking=no root@10.30.212.58 ' cd /var/www/html && git clone https://github.com/herjflorez/Proyecto2-Grupo2.git || git config --global --add safe.directory /var/www/html/Proyecto2-Grupo2 || (cd /var/www/html/Proyecto2-Grupo2 && git pull)'
                    '''
                }
            }
        }
